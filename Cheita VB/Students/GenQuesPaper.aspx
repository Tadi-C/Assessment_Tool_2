<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GenQuesPaper.aspx.vb" Inherits="Cheita_VB.GenQuesPaper" %>
...
<div class="ques_cont">
    ...
    <div class="cont" id="questionContainer">
            <div>
                <select style="border-radius:8px;width:100%;margin-bottom:10%">
                <option value="option1">Generate Paper 1</option>
                <option value="option2">Generate Paper 2</option>
                <option value="option3">Generate Paper 3</option>
                </select>
            </div>
            ...
            <div style="display:flex">
                ...
                <select style="border-radius:8px;width:30%;margin-bottom:10%;margin-left:5%;">
                ...
                <option value="option3">90</option>
                       ...
                       <div style="display:flex">
                <label>Number of Questions in Section A</label>
                <select style="border-radius:8px;width:30%;margin-bottom:10%;margin-left:5%;">
                ...
                <option value="option3">15</option>
                       ...
                       <div style="display:flex">
                <label>Number of Questions in Section B</label>
                <select style="border-radius:8px;width:30%;margin-bottom:10%;margin-left:5%;">
                <option value="option1">5</option>
                <option value="option2">10</option>
                <option value="option3">15</option>
                               ...
                               <div style="display:flex">
                <label>Number of Questions in Section C</label>
                <select style="border-radius:8px;width:30%;margin-bottom:10%;margin-left:5%;">
                <option value="option1">5</option>
                <option value="option2">10</option>
                <option value="option3">15</option>
      ...
      <div style="display:flex; justify-content:center;">
            <a class="button1" ID="Button1">Generate</a>
        </div>
    </div>
</div>
