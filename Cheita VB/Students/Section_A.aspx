<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Section_A.aspx.vb" Inherits="Cheita_VB.Section_A" %>
            ...
            <div class="content-wrapper">
                                ...
                                <div class="card">
                                    ...
                                    <div class="radio-button-group">
                                        <div style="display: flex; align-items: center;">
                                            ...
                                            <asp:RadioButton ID="RadioButton1" GroupName='group1' Text='<%# Eval("Option1") %>' runat="server" />
                                        </div>
                                        <div style="display: flex; align-items: center;">
                                            <asp:RadioButton ID="RadioButton2" GroupName='group1' Text='<%# Eval("Option2") %>' runat="server" />
                                        </div>
                                        <div style="display: flex; align-items: center;">
                                            <asp:RadioButton ID="RadioButton3" GroupName='group1' Text='<%# Eval("Option3") %>' runat="server" />
                                        </div>
                                        <div style="display: flex; align-items: center;">
                                            <asp:RadioButton ID="RadioButton4" GroupName='group1' Text='<%# Eval("Option4") %>' runat="server" />
                                        </div>
                                    </div>
                                </div>
                            </ItemTemplate>
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="Section B.aspx">Section_B</a></li>
                        <li><a href="Section C.aspx">Section_C</a></li>
                        <li><a href="Section D.aspx">Section_D</a></li>
                    </ul>
                </nav>
