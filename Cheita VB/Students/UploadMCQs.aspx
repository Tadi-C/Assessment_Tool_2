<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UploadMCQs.aspx.vb" Inherits="Cheita_VB.UploadMCQs" %>
...
<div class="ques_cont">
  ...
  <asp:TextBox TextMode="MultiLine" Rows="4" Wrap="true" style="border-color: black; width: 600px; height: 300px; margin-bottom: 5%; border-radius: 20px; padding: 10px; resize: none; text-align: left;" ID="Question" runat="server" placeholder="Enter your question here"></asp:TextBox>
        ...
        <div style="display: flex;align-items: center;padding: 10px 5px;margin-block: 2%;border-radius:10px;">
            <input id="RadioButton1" type="radio" name="radioButtonGroup" value="RadioButton1" style="margin-right:3%"> 
            <asp:TextBox  style="border-color:black; width: -webkit-fill-available;height: 50px;border-radius: 20px;" ID="Option1" runat="server" placeholder="Option 1"></asp:TextBox>
        </div>
        <div style="display: flex;align-items: center;padding: 10px 5px;margin-block: 2%;border-radius:10px">
            <input id="RadioButton2" type="radio" name="radioButtonGroup" value="RadioButton2" style="margin-right:3%"> 
            <asp:TextBox style="border-color:black; width: -webkit-fill-available;height: 50px;border-radius: 20px;" ID="Option2" runat="server" placeholder="Option 2"></asp:TextBox>
        </div>
        <div style="display: flex;align-items: center;padding: 10px 5px;margin-block: 2%;border-radius:10px">
            <input id="RadioButton3" type="radio" name="radioButtonGroup" value="RadioButton3" style="margin-right:3%"> 
            <asp:TextBox style="border-color:black; width: -webkit-fill-available;height: 50px;border-radius: 20px;" ID="Option3" runat="server" placeholder="Option 3"></asp:TextBox>
        </div>
        <div style="display: flex;align-items: center;padding: 10px 5px;margin-block: 2%;border-radius:10px">
            <input id="RadioButton4" type="radio" name="radioButtonGroup" value="RadioButton4" style="margin-right:3%"> 
            <asp:TextBox style="border-color:black; width: -webkit-fill-available;height: 50px;border-radius: 20px;" ID="Option4" runat="server" placeholder="Option 4"></asp:TextBox>
        </div>
        <div style="display:flex; justify-content:center;">
            <a class="button1" ID="Button1" runat="server" onserverclick="btn_submit_click">Insert</a>
        </div>
    </div>
</div>
