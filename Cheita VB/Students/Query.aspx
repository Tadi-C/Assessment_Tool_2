<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Students/ChietaWebMaster.Master" CodeBehind="Query.aspx.vb" Inherits="Cheita_VB.Query" %>
...
<div class="flex-col">
    ...
    <div class="form-box">
        <div class="qform-row"><span class="lblText">Subject:</span><input type="text" class="qtext-box" name="subject" id="txtSubjext" runat="server"/> </div>       
        <div class="qform-col">
        ...
        <div class="qform-col" >
           ...
           <div class="scrollable" style="max-height:25vh">
            <table class="tableQ">
              <thead>
                <tr>
                  <th>Name</th>
