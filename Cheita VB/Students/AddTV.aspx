<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddTV.aspx.vb" Inherits="Cheita_VB.AddTV" %>
<!DOCTYPE html>
...
.button3:active {
  ...
  iframe {
    ...
    box-shadow: 0 0 5px rgba(0, 0, 0, 0.2); /* Apply box shadow */
  }
  ...
  .button4 {
    ...
    background-color: #411f51; /* Set the background color */
  ...
  .button4:hover {
    background-color: #650c8f; /* Change the background color on hover */
  }
    </style>
...
<div class="ques_cont">
    ...
    <div>
        ...
        <div style="margin-top:5%;">
            <asp:TextBox style="border-color:black; width: 500px;height: 30px;border-radius: 20px;" ID="Option4" runat="server" placeholder="Enter URL"></asp:TextBox>
            <asp:Button ID="Button2" runat="server" CssClass="button4"  Text="Upload" />
        </div>
